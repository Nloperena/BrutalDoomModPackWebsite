      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="feature-card bg-[#2c2c2c] p-6 rounded-lg text-center">
            ...
            <img src={HeaderImage} alt="Fluid Gameplay" className="w-full h-48 object-cover mb-4" />
            <p className="text-lg">
          ...
          <div className="feature-card bg-[#2c2c2c] p-6 rounded-lg text-center">
            ...
            <img src={HeaderImage} alt="Custom Animations" className="w-full h-48 object-cover mb-4" />
            <p className="text-lg">
          ...
          <div className="feature-card bg-[#2c2c2c] p-6 rounded-lg text-center">
            ...
            <img src={HeaderImage} alt="Unique Enemy Behavior" className="w-full h-48 object-cover mb-4" />
            <p className="text-lg">
